...
mkdir -p $DEV_ENV_DIR
cp /home/vagrant/user-home/oe-hr-portal-service.properties $DEV_ENV_DIR/oe-hr-portal-service.properties
...
mkdir -p $SSL_DIR
cp /vagrant/oe-hr-portal-service.crt $SSL_DIR
cp /vagrant/oe-hr-portal-service.key $SSL_DIR
...
# update the vagrant box /etc/hosts to look at the host machine for oe-hr-portal-service.
# At some point, oe-hr-portal-service will be in a vagrant box too, so this will need to
# be updated.
ETC_HOSTS=/etc/hosts
HOST_OS_IP=10.0.2.2
LOCAL_HOST_IP=127.0.0.1
POSTGRES_NAME="postgres.dev.openenglish.com"
HOSTS_APP_NAME="oe-hr-portal-service.dev.openenglish.com"
